package com.fretamentofacil.auth.infra.security;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        ...
        return  httpSecurity.cors().and()
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.GET, "/auth/login/{id}").permitAll()
                        .requestMatchers(HttpMethod.GET, "/auth/login/{id}").hasRole("USER")
                        .requestMatchers(HttpMethod.PUT, "/auth/changepassword/{id}").hasRole("USER")
                        ...
                        .requestMatchers(HttpMethod.GET, "/excluidos").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.PUT, "/reativar/{id}").hasRole("ADMIN")
                        ...
                        .requestMatchers(HttpMethod.GET, "/cargas/").permitAll()
                        .requestMatchers(HttpMethod.DELETE, "/condutor/delete/{id}").
