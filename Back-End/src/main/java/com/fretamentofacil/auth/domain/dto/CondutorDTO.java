...
public record CondutorDTO(Long id,String login, String password, UserRole role, String nome, String cpf,String telefone,
                          String cep,String endereco, String tipo_Veiculo , Double capacidadeVeiculo,
